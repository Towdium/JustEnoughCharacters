...
public class JeiTransformer implements ITransformer {
    ...
    public ClassNode transform(ClassNode node) {
        ...
        ITransformer.findMethod(node, "<init>", "(Lmezz/jei/api/runtime/IIngredientManager;Lmezz/jei/config/IIngredientFilterConfig;)V")
                .ifPresent(method -> ITransformer.transformInvokeLambda(method,
                        "mezz/jei/search/suffixtree/GeneralizedSuffixTree",
                        "<init>",
                        "()V",
        ...
        ITransformer.findMethod(node, "parseSearchTokens", "(Ljava/lang/String;)Lmezz/jei/ingredients/IngredientFilter$SearchTokens;")
                .ifPresent(method -> {
