...
public enum Keyboard {
    ...
    private static final ImmutableMap<String, String> PHONETIC_SYMBOL = new ImmutableMap.Builder<String, String>()
            .put("a", "ㄚ")
            .put("o", "ㄛ")
            .put("e", "ㄜ")
            .put("er", "ㄦ")
    ...
    private static final ImmutableMap<String, String> PHONETIC_SPELL = new ImmutableMap.Builder<String, String>()
            .put("yi", "i")
            .put("you", "iu")
            .put("yin", "in")
            .put("ye", "ie")
    ...
    private static Char2ObjectMap<String> KEYBOARD_DAQIAN = new Char2ObjectOpenHashMap<>(new ImmutableMap.Builder<Character, String>()
            .put('ㄇ', "a")
            .put('ㄖ', "b")
            .put('ㄏ', "c")
            .put('ㄎ', "d")
